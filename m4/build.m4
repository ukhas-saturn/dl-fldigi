...
$LIBMBEDTLS_CFLAGS $CURL_CFLAGS $SSL_CFLAGS \
$INTL_CFLAGS $PTW32_CFLAGS $BFD_CFLAGS -pipe -Wall -fexceptions $OPT_CFLAGS $DEBUG_CFLAGS -lpaho-mqtt3c"
...
$EXTRA_LIBS $FLXMLRPC_LIBS $LIBMBEDTLS_LIBS $CURL_LIBS $SSL_LIBS"
